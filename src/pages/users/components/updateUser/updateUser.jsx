      ...
      <form className={styles.form} onSubmit={onSubmit}>
        <label className={styles.label}>
          ...
          <input
            ...
            onChange={(event) => setUserForUpdate({ ...userForUpdate, ...{ name: event.target.value } })}
          />
        </label>
        <label className={styles.label}>
          Login:
          <input
            ...
            onChange={(event) => setUserForUpdate({ ...userForUpdate, ...{ login: event.target.value } })}
          />
        </label>
        <label className={styles.label}>
          Password:
          <input
            ...
            onChange={(event) => setUserForUpdate({ ...userForUpdate, ...{ password: event.target.value } })}
            required
          />
        </label>
